...
export function isletme_validate(values, subCategory) {
  ...
  if (subCategory === "Sıcak Su") {
    if (!values.ph) {
      errors.ph = "Bu alan boş bırakılamaz";
    } else if (values.ph < 7 || values.ph > 8.5) {
...
export function tuzSodaSayacToplama_validate(values) {
  ...
  if (values.uretilenSu === undefined || values.uretilenSu === null) {
    errors.uretilenSu = "Bu alan boş bırakılamaz";
  }

  if (values.tasviyedeKullanilanSiviTuzSayac === undefined || values.tasviyedeKullanilanSiviTuzSayac === null) {
    errors.tasviyedeKullanilanSiviTuzSayac = "Bu alan boş bırakılamaz";
  }

  if (values.tuzVeSodaTesisiKullanilanSuSayac === undefined || values.tuzVeSodaTesisiKullanilanSuSayac === null) {
    errors.tuzVeSodaTesisiKullanilanSuSayac = "Bu alan boş bırakılamaz";
  }

  if (values.isletmeyeVerilenSiviTuzSayac === undefined || values.isletmeyeVerilenSiviTuzSayac === null) {
    errors.isletmeyeVerilenSiviTuzSayac = "Bu alan boş bırakılamaz";
  }
  if (
    values.isletmeyeVerilenSiviTuzHazirlananTankSayisi === undefined ||
    values.isletmeyeVerilenSiviTuzHazirlananTankSayisi === null
  ) {
    errors.isletmeyeVerilenSiviTuzHazirlananTankSayisi =
      "Bu alan boş bırakılamaz";
  }

  if (values.hazirlananSiviSodaSayac === undefined || values.hazirlananSiviSodaSayac === null) {
    errors.hazirlananSiviSodaSayac = "Bu alan boş bırakılamaz";
  }
  if (values.siviSodaHattiYikamaSuyuSayac === undefined || values.siviSodaHattiYikamaSuyuSayac === null) {
    errors.siviSodaHattiYikamaSuyuSayac = "Bu alan boş bırakılamaz";
  }

  if (values.katiSodaKg === undefined || values.katiSodaKg === null) {
    errors.katiSodaKg = "Bu alan boş bırakılamaz";
  }

  if (values.aritmaTesisineAtilanAtikSiviTuzuLt === undefined || values.aritmaTesisineAtilanAtikSiviTuzuLt === null) {
...
export function tuzTesisiKontrolCizelgesi_validate(values) {
  ...
  if (!values.ph) {
    errors.ph = "Bu alan boş bırakılamaz";
  } else if (values.ph < 6 || values.ph > 7) {
    errors.ph = "pH 6.00-7.00 aralığında değer giriniz!";
  }
  if (!values.yogunluk) {
    errors.yogunluk = "Bu alan boş bırakılamaz";
  } else if (values.yogunluk < 1.19 || values.yogunluk > 1.195) {
    errors.yogunluk = "1.190 - 1.195 gr/cm3 aralığında değer giriniz!";
  }
  if (!values.bikarbonat) {
    errors.bikarbonat = "Bu alan boş bırakılamaz";
  } else if (values.bikarbonat > 40) {
    errors.bikarbonat = "Maximum 40 ppm değer giriniz!";
  }
...
export function sodaTesisiKontrolFormu_validate(values) {
  ...
  if (!values.cozeltiYogunlugu) {
    ...
    values.cozeltiYogunlugu < 1.163 ||
    values.cozeltiYogunlugu > 1.168
  ) {
    errors.cozeltiYogunlugu = "1.163 - 1.168 gr/cm3 aralığında değer giriniz!";
  }
  if (!values.kontrolEden) {
    errors.kontrolEden = "Bu alan boş bırakılamaz";
  }
...
export function sodyumKlorurKontrolFormu_validate(values) {
  ...
  } else if (values.demir > 1) {
    errors.demir = "Maximum 1ppm giriniz!";
  }
  ...
  //Max 40AS
  else if (values.sertlik > 40) {
    errors.sertlik = "Maximum 40AS giriniz!";
  }
