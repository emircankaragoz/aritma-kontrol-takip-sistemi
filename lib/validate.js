...
export function renkGidericiTuketimi_validate(values, yavasKaristirmaHavCikisiMin, yavasKaristirmaHavCikisiMax, kimyasalCokHavCikisiRenkMin, kimyasalCokHavCikisiRenkMax) {
  const errors = {};
  ...
  } else if (values.yavasKaristirmaHavCikisi < yavasKaristirmaHavCikisiMin || values.yavasKaristirmaHavCikisi > yavasKaristirmaHavCikisiMax) {
    errors.yavasKaristirmaHavCikisi = `${yavasKaristirmaHavCikisiMin} - ${yavasKaristirmaHavCikisiMax} Pt-Co aralığında değer giriniz!`;
  }
  if (!values.kimyasalCokHavCikisiRenk) {
    errors.kimyasalCokHavCikisiRenk = "Bu alan boş bırakılamaz";
  }
  else if (values.kimyasalCokHavCikisiRenk < kimyasalCokHavCikisiRenkMin || values.kimyasalCokHavCikisiRenk > kimyasalCokHavCikisiRenkMax) {
    errors.kimyasalCokHavCikisiRenk = `${kimyasalCokHavCikisiRenkMin} - ${kimyasalCokHavCikisiRenkMax} Pt-Co aralığında değer giriniz!`;
  }
...
//Filtrepress
export function filtrepresAnalizFormu_validate(values,camurKekiNemMin,camurKekiNemMax) {
  const errors = {};

  if (!values.camurKekiNem) {
    errors.camurKekiNem = "Bu alan boş bırakılamaz";
  } else if (values.camurKekiNem < camurKekiNemMin || values.camurKekiNem > camurKekiNemMax) {
    errors.camurKekiNem = `${camurKekiNemMin} - ${camurKekiNemMax} % aralığında değer giriniz!`;
  }
  if (!values.filtrepresSarjSayisi) {
    errors.filtrepresSarjSayisi = "Bu alan boş bırakılamaz";
  }
